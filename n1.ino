...
//     unlockDoor();
//     autoLockTime = millis() + 10000; // Auto-lock in 5 seconds
//     autoLockActive = true;
//     playSuccessBeep();
...
//       if (alarmToneState) {
//         tone(BUZZER_PIN, 800, 250); // High pitch
//       } else {
//         tone(BUZZER_PIN, 400, 250); // Low pitch
//       }
...
// // Success beep - 2 high tones
// void playSuccessBeep() {
//   tone(BUZZER_PIN, 1000, 100); // 1000 Hz for 100ms
//   delay(150);
//   tone(BUZZER_PIN, 1200, 100); // 1200 Hz for 100ms
//   delay(150);
//   noTone(BUZZER_PIN);
//   Serial.println("Success beep played");
// }

// // Error beep - 3 low tones
// void playErrorBeep() {
//   tone(BUZZER_PIN, 300, 200); // 300 Hz for 200ms
//   delay(250);
//   tone(BUZZER_PIN, 250, 200); // 250 Hz for 200ms
//   delay(250);
//   tone(BUZZER_PIN, 200, 300); // 200 Hz for 300ms
//   delay(350);
//   noTone(BUZZER_PIN);
//   Serial.println("Error beep played");
// }

// // Lock confirmation beep - single medium tone
// void playLockBeep() {
//   tone(BUZZER_PIN, 800, 150); // 800 Hz for 150ms
//   delay(200);
//   noTone(BUZZER_PIN);
...
//   // Progress bar
//   int progress = ((millis() / 100) % 80) + 10;
//   display.drawRect(20, 55, 88, 6, SSD1306_WHITE);
//   display.fillRect(21, 56, progress, 4, SSD1306_WHITE);
...
//     int height = (i + 1) * 4;
//     display.fillRect(50 + i * 8, 45 - height, 6, height, SSD1306_WHITE);
//   }
...
//   display.drawLine(55, 25, 61, 31, SSD1306_WHITE);
//   display.drawLine(61, 31, 73, 19, SSD1306_WHITE);
  
//   // Pulsing effect
//   if ((millis() / 200) % 2) {
//     display.drawCircle(64, 25, 17, SSD1306_WHITE);
//   }
...
//   display.setCursor((128 - employeeName.length() * 6) / 2, 58);
...
//   display.println("MANUAL UNLOCK");
  
//   // Key icon
//   display.drawRect(50, 20, 8, 4, SSD1306_WHITE);
